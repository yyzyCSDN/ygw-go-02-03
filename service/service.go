...
import (
	...
	"example.com/inventoryreplenisher/audit"
	"example.com/inventoryreplenisher/batch"
	"example.com/inventoryreplenisher/model"
	"example.com/inventoryreplenisher/query"
	"example.com/inventoryreplenisher/snapshot"
	"example.com/inventoryreplenisher/store"
)
...
func (service *Service) Save(actor string, value model.Item) (model.Item, error) {
...
func (service *Service) Get(id string) (model.Item, bool) {
	return service.store.Get(id)
}

func (service *Service) List(filter query.Filter, field query.SortField, descending bool) ([]model.Item, error) {
