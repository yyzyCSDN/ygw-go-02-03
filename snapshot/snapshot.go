...
func (manager *Manager) Capture(reason string, values []model.Item) Snapshot {
	manager.mu.Lock()
...
func (manager *Manager) Restore(id uint64) ([]model.Item, error) {
...
func cloneValues(values []model.Item) []model.Item {
